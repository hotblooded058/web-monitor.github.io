...
function restore(e) {
    ...
    if (file.type === "application/json") {
        ...
        reader.onload = readerEvent => {
            ...
            storage.saveTabs(tabs,allDatadeletedAndRestored);
        }
    } else {
...
function allDatadeletedAndRestored() {
...
function addDomainToListBox(domain) {
    ...
    del.title="Remove the site from the ignored list";
    del.height = 12;
...
function addDomainToEditableListBox(entity, elementId, actionEdit, actionDelete, actionUpdateTimeFromList, actionUpdateList) {
	...
	edit.title="Edit the time limit set earlier";
    edit.height = 14;
    ...
    var del = document.createElement('img');
    del.title="Remove the site url and time limit from the list";
	del.height = 12;
    del.src = '/icons/delete.png';
